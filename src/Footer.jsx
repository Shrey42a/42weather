...
function Footer() {
    return (
        <>
            <div className="h-max w-full py-2 text-gray-100 bg-white/10 backdrop-blur border-t border-lime-400">
                <ul className="flex w-full flex-col items-center justify-center space-y-4 py-4 lg:flex-row lg:space-x-10 lg:space-y-0">
                    <li className="text-sm font-bold uppercase transition ease-in-out hover:text-gray-400"><a href="#home">Home</a></li>
                    <li className="text-sm font-bold uppercase transition ease-in-out hover:text-gray-400"><a href="#About us">About Us</a></li>
                    <li className="text-sm font-bold uppercase transition ease-in-out hover:text-gray-400"><a href="#PP">Privacy Policy</a></li>
                    <li className="text-sm font-bold uppercase transition ease-in-out hover:text-gray-400"><a href="COntact us">Contact us</a></li>
                </ul>

                <div className="flex flex-col py-4">
                    <h1 className="text-center text-2xl font-semibold">Download The App</h1>
                    <div className="flex flex-row items-center justify-center space-x-4 py-2">
                        <div className="flex space-x-1 rounded-md bg-white/10 p-2 text-black/40 shadow-inner shadow-slate-400 saturate-150 backdrop-blur-md hover:shadow-teal-700">
                            ...
                            <a className="" href="#googleplay">Google Play</a>
                        </div>
                        <div className="flex space-x-1 rounded-md bg-black/10 p-2 text-black/40 shadow-inner shadow-slate-400 saturate-150 backdrop-blur-md hover:shadow-teal-700">
                            <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" width="64" height="64" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fill="gray" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 640 640"><path d="M494.782 340.02c-.803-81.025 66.084-119.907 69.072-121.832-37.595-54.993-96.167-62.552-117.037-63.402-49.843-5.032-97.242 29.362-122.565 29.362-25.253 0-64.277-28.607-105.604-27.85-54.32.803-104.4 31.594-132.403 80.245C29.81 334.457 71.81 479.58 126.816 558.976c26.87 38.882 58.914 82.56 100.997 81 40.512-1.594 55.843-26.244 104.848-26.244 48.993 0 62.753 26.245 105.64 25.406 43.606-.803 71.232-39.638 97.925-78.65 30.887-45.12 43.548-88.75 44.316-90.994-.969-.437-85.029-32.634-85.879-129.439l.118-.035zM414.23 102.178C436.553 75.095 451.636 37.5 447.514-.024c-32.162 1.311-71.163 21.437-94.253 48.485-20.729 24.012-38.836 62.28-33.993 99.036 35.918 2.8 72.591-18.248 94.926-45.272l.036-.047z" /></svg><a className="" href="#Appstore">App Store</a>
                        </div>
                    </div>
                </div>
                <h1 className="text-md text-center font-semibold ">Made With 42 At <a target="blank" href="https://codeyogi.io/" title="Visit Codeyogi" className="text-cyan-500 cursor-pointer">Codeyogi Labs</a></h1>
                <div className="flex flex-col items-center justify-center space-y-2 py-4">
                    <h1 className="text-center ">
                        Copyright &#169; 2022 <span className="text-cyan-500"><a href="#home">Four2 Weather</a></span> BIS
                    </h1>
