...
function Footer() {
    return (
        <>
            <div className="h-max w-full py-2 bg-white/10 backdrop-blur border-t border-lime-400">
                <ul className="flex w-full flex-col items-center justify-center space-y-4 py-4 lg:flex-row lg:space-x-10 lg:space-y-0">
                    <li className="text-sm font-bold uppercase text-black/90 transition ease-in-out hover:text-gray-400"><a href="#home">Home</a></li>
                    <li className="text-sm font-bold uppercase text-black/90 transition ease-in-out hover:text-gray-400"><a href="#About us">About Us</a></li>
                    <li className="text-sm font-bold uppercase text-black/90 transition ease-in-out hover:text-gray-400"><a href="#PP">Privacy Policy</a></li>
                    <li className="text-sm font-bold uppercase text-black/90 transition ease-in-out hover:text-gray-400"><a href="COntact us">Contact us</a></li>
                </ul>
